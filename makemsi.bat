...
set InstallerFiles= %GeneratedWXSFiles% .\installer\Features.wxs .\installer\EnvVars.wxs .\installer\Shortcuts.wxs .\installer\Main.wxs
set InstallerObjectFiles= .\installer\Emacs.wixobj .\installer\Features.wixobj .\installer\EnvVars.wixobj .\installer\Shortcuts.wixobj .\installer\Main.wixobj
